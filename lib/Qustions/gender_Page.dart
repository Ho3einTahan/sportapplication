...
class _gender_PageState extends State<gender_Page> {
  ...
  Widget build(BuildContext context) {
    Map<String, dynamic> userData = {"gender": null, "sickness": null, "target": null, "bodylevel": null, "weight": null, "height": null};
    return Scaffold(
      body: Column(
                    ...
                    children: [
                      AnimatedOpacity(
                        ...
                        child: AnimatedScale(
                          ...
                          child: Image.asset("images/man.png", width: 120, height: 278),
                        ),
                      ),
                      Padding(
                        ...
                        child: Visibility(
                          visible: visibleMan,
                          child: Image.asset("images/blue.png", height: 130, width: 130),
                        ),
                      ),
                      AnimatedOpacity(
                        opacity: ManOpacity,
                    ...
                    children: [
                      AnimatedOpacity(
                        ...
                        child: AnimatedScale(
                          scale: WomanScale,
                          duration: Duration(milliseconds: 300),
                          child: Image.asset("images/woman.png", width: 156, height: 278),
                        ),
                      ),
                      Padding(
                        ...
                        child: Visibility(
                          ...
                          child: Image.asset("images/pink.png", width: 130, height: 130),
                        ),
                      ),
                      AnimatedOpacity(
                        opacity: WomanOpacity,
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (BuildContext context) {
                        return Sickness_Page(userData: userData);
                      },
                    ),
                  );
                },
