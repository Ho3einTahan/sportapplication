                ...
                child: Row(
                  children: [
                    Padding(
                      ...
                      child: getBoxSickness(text: "یبوست", size: 71, visibtly: false, userData: {}),
                    ),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      SizedBox(width: 27),
                      getBoxSickness(text: "دیابت نوع 1", size: 78, visibtly: false, userData: {}),
                      SizedBox(width: 16),
                      getBoxSickness(text: "دیابت نوع 2", size: 101, visibtly: false, userData: {}),
                      SizedBox(width: 16),
                      getBoxSickness(text: "کم کاری تیروئید", size: 101, visibtly: false, userData: {}),
                      SizedBox(width: 16),
                    ],
                  ),
                ),
              ...
              Padding(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      SizedBox(width: 27),
                      getBoxSickness(text: "یبوست", size: 71, visibtly: false, userData: {}),
                      SizedBox(width: 16),
                      getBoxSickness(text: "ریفلاکس معده", size: 71, visibtly: false, userData: {}),
                      SizedBox(width: 16),
                      getBoxSickness(text: "عفونت معده", size: 71, visibtly: false, userData: {}),
                      SizedBox(width: 16),
                      getBoxSickness(text: "عفونت", size: 46, visibtly: false, userData: {}),
                      SizedBox(width: 16),
                    ],
                  ),
                ),
              ...
              Padding(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      SizedBox(width: 27),
                      getBoxSickness(text: "دیسک کمر", size: 71, visibtly: false, userData: {}),
                      SizedBox(width: 16),
                      getBoxSickness(text: "دیسک کمر", size: 71, visibtly: false, userData: {}),
                      SizedBox(width: 16),
                      getBoxSickness(text: "دیسک کمر", size: 71, visibtly: false, userData: {}),
                      SizedBox(width: 16),
                      getBoxSickness(text: "آرتروز", size: 46, visibtly: false, userData: {}),
                      SizedBox(width: 16),
                    ],
                  ),
                ),
              ...
              Padding(
                ...
                child: ClipRRect(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text("بعدی", style: TextStyle(fontSize: 20, color: Colors.white)),
                  ),
                ),
              ),
              SizedBox(height: 12),
...
class getBoxSickness extends StatefulWidget {
  getBoxSickness({super.key, this.text, this.size, this.visibtly, required this.userData});
      ...
      child: Stack(
        ...
        children: [
            ...
            onTap: () async {
              if (widget.visibtly == false && bordercolor == Color(0xffF2F2F2)) {
                setState(() {
                  ...
                  Sickness_Page(userData: widget.userData).userData = widget.userData;
                });
              } else {
                setState(() {
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  ...
                  stops: [0.5, 0.1],
                  colors: [Color.fromRGBO(255, 255, 255, 0.5), Color.fromRGBO(220, 239, 214, 0.5)],
                ),
              ),
              child: Center(
                  child: Text(
          ...
          FractionalTranslation(
            ...
            child: Visibility(visible: widget.visibtly!, child: Image.asset("images/tick1.png", width: 15, height: 15)),
          ),
        ],
      ),
    );
